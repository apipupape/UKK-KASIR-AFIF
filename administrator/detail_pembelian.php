                         ...
                         <table class="table table-bordered table-striped">
                              ...
                              <tbody>
                                   ...
                                   <form action="simpan_total_harga.php" method="post">
                                        <?php
                                        include '../koneksi.php';
                                        $detailpenjualan = mysqli_query($koneksi, "SELECT SUM(Subtotal) AS TotalHarga FROM
                                         detailpenjualan WHERE PenjualanID='$d[PenjualanID]'");
                                        ...
                                        <div class="row">
                                             ...
                                             <div class="col-sm-2">
                                                  <div class="form-group">
                                                       <button type="submit" class="btn btn-primary btn-sm form-control">Simpan</button>
                                                  </div>
                                             </div>
                                        </div>
                                   </form>
